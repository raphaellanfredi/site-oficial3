            ...
            {progress.map((state, i) => (
              <div
                ...
                style={{
                  ...
                  height: "4px",
                  borderRadius: "99px",
                  background: state === "pending" ? "rgba(242,244,241,0.14)" : undefined,
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "20px", gap: "12px" }}>
              <button
                ...
                style={{
                  ...
                  color: current === 0 ? "rgba(242,244,241,0.3)" : "var(--ink-2)",
                  minHeight: "48px",
          ...
          return (
            <label
              ...
              style={{
                display: "block",
                padding: "18px 16px",
                background: checked ? "rgba(255,0,128,0.05)" : "var(--surface)",
                border: `1.5px solid ${checked ? "var(--brand-pink)" : "rgba(242,244,241,0.16)"}`,
                borderRadius: "10px",
                transition: "all 0.2s",
              }}
            >
          ...
          return (
            <label
              ...
              style={{
                ...
                minHeight: "44px",
                background: checked ? "rgba(255,0,128,0.05)" : "var(--surface)",
                border: `1px solid ${checked ? "var(--brand-pink)" : "rgba(242,244,241,0.16)"}`,
                borderRadius: "99px",
                fontSize: "14px",
                fontWeight: 500,
      ...
      return (
        <div
          style={{
            ...
            textAlign: "center",
            background: "var(--surface)",
            border: "1px dashed rgba(242,244,241,0.2)",
            borderRadius: "10px",
          }}
        >
              ...
              <span style={{ position: "relative", width: "44px", height: "26px", flexShrink: 0 }}>
                <span
                  style={{
                    position: "absolute",
                    inset: 0,
                    background: checked ? "var(--brand-pink)" : "rgba(242,244,241,0.2)",
                    borderRadius: "99px",
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          ...
          style={{
            ...
            fontSize: "14px",
            fontWeight: 600,
            border: "1px solid rgba(242,244,241,0.2)",
            background: "transparent",
            color: "var(--ink-2)",
            minHeight: "48px",
          }}
