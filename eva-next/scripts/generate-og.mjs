...
const PAGES = [
  ...
  { slug: "para-empresas", shape: "apple", kicker: "Eva para empresários", title: "O braço direito que", fruit: "não tira férias.", sub: "Atende, vende e agenda no WhatsApp, no Instagram e no telefone." },
  { slug: "para-clinicas", shape: "clock", kicker: "Eva para clínicas", title: "Nenhum paciente sem", fruit: "resposta.", sub: "Atende, marca a consulta e confirma no dia. A qualquer hora." },
  { slug: "para-escritorios", shape: "tree", kicker: "Eva para escritórios", title: "Cada pedido no", fruit: "lugar certo.", sub: "Triagem, encaminhamento e reunião marcada. Advocacia, contabilidade e consultoria." },
